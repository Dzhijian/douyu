...
public class ZJPageOptions{
    ...
    /// 滚动条 scrollLine 宽度
    public var kScrollLineWidth : CGFloat = 0
    /// scrollView 的背景颜色
    public var kscrollViewBGColor : UIColor = kWhite
    /// scrollView背景渐变色
    public var kGradColors : [CGColor]? = nil
    /// 是否显示底部的分割线
    public var showBottomBorderLine : Bool = true
    /// 底部分割线的颜色
    public var kBottomLineColor : UIColor = UIColor.gray
    /// 位置
    public var itemAliginment : ItemAliginment = ItemAliginment.left
